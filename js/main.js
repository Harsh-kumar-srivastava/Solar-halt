...
// Open Whatsapp
function changeButtonText(event, button) {
    event.preventDefault(); 
    
    let message = "Hello, I am contacting you from the SolarTec Company!";
    let phoneNumber = "0123456789"; // Replace with your WhatsApp number
    let whatsappURL;
